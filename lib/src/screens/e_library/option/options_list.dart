Map<String, String> trainingManual = {
  "title": "T. Manual",
  "svg":
...
Map<String, String> eSalesAidOption = {
  "title": "E-Sales Aid",
  "svg":
...
Map<String, String> campaignsOption = {
  "title": "Campaigns",
  "svg":
